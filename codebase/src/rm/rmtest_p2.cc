...
RC TEST_RM_PRIVATE_2(const string &tableName)
{
    ...
    for(int i = 0; i < numTuples; i++)
    {
		...
		if (i%50 == 0) {
				//nullBit = *(unsigned char *)((char *)returnedData) & (01010100);
		...
		cout << " is test fail ? " << testFail << endl;
